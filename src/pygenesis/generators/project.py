...
from pygenesis.utils.filters import TemplateFilters
...
class ProjectGenerator(BaseGenerator):
    ...
    def generate(
        ...
        description = description or f"{name} — generated by PyGenesis"
        ...
        _generate_pygenesis_toml(root, name, github_owner)
...
def _generate_pygenesis_toml(root: Path, name: str, github_owner: str) -> None:
    content = PyGenesisConfig.generate_default(name)
    toml_path = root / "pygenesis.toml"
